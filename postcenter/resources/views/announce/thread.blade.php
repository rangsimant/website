<div class="email-opened" id="thread" hidden>
              <div class="email-content-wrapper" style="">
                <div class="actions-wrapper menuclipper bg-master-lightest">
                  <ul class="actions menuclipper-menu no-margin p-l-20 ">
                    ...
                    </li><div class="dropdown menuclipper-dropdown" style="display: none;"><button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="caret"></span></button><ul class="dropdown-menu menuclipper-dropdown-menu pull-right" role="menu"><li role="presentation"><a href="#" class="text-danger">Delete</a>
                    </li></ul></div>
              ...
              <section class="timeline">
                ...
                <!-- timeline-block -->
                <div class="timeline-block">
                  <div class="timeline-point warning is-hidden">
                    <i class="pg-social"></i>
                  </div>
                  <!-- timeline-point -->
                ...
                <!-- timeline-block -->
                <div class="timeline-block">
                  <div class="timeline-point small is-hidden">
                  </div>
                  <!-- timeline-point -->
                  <div class="timeline-content is-hidden">
                    <div class="card share full-width ">
